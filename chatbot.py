...
class Chatbot:
    ...
    def add_entry(self, user_input):
        ...
        self.new_entry.append(user_input)
    ...
    def ask_name(self, user_input):
        ...
        if names == None and not user_input.lower() in ["yes",
                                                        "no"]: return "Sorry I didnt recognise a name? What is your name?"
